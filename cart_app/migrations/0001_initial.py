# Generated by Django 4.2.3 on 2025-03-02 10:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('rfid_card', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cart_app.rfidcard')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
            fields=[
                ...
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='cart_app.product')),
            ],
        ),
        migrations.CreateModel(
            name='CartItem',
